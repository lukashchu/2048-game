...
public final class PennDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    // boundary of drawing canvas, 0% border, scale factor to convert back to window
    // coordinates
    // (used to be a 5% border, and we might as well leave the constant in the code
    // so
    ...
    /**
     * Set the font to the given font, with the same style and point size as the
     * current font.
     * 
    ...
    /**
     * Set the font to the given font and size, with the same style as the current
     * font.
     * 
     * @param fontName  the font to make text
    ...
    /**
     * Draw everything immediately (equivalent to calling PennDraw.show() with no
     * arguments)
     */
